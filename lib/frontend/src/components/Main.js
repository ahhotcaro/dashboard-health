...
export default function Main() {
  ...
  useEffect(() => {
    ...
    const fetchRandomSport = async () => {
      const idSport = [1, 4, 5, 960, 12, 19, 20, 23, 29, 36, 37, 38, 39, 40, 44, 45, 46, 49, 51, 57, 58, 66, 67, 68, 69, 70, 73, 74, 76, 78, 81, 82, 83, 86, 87, 89, 90, 91, 93, 95, 96, 98, 100, 101, 103, 105, 106, 109];
